...
<table cellspacing="0">
  <tr>
    ...
    <td colspan="3" style="color: #FFF">1일 객실이용요금</td>
  </tr>
  ...
  <tr>
    ...
    <td><font style="background:#FFd0d0; padding:1px 1px 1px 1px;">객실명</font> 로즈마리<br />
      <font style="background:#FFd0d0; padding:1px 1px 1px 1px;">객실면적</font> 12평(40㎡)<br />
      <font style="background:#FFd0d0; padding:1px 1px 1px 1px;">객실유형</font> 커플침대<br />
      <font style="background:#FFd0d0; padding:1px 1px 1px 1px;">기준/최대</font> 2명 / 3명<br /></td>
...
<table cellspacing="0">
  ...
  <tr>
    <td>바베큐</td>
    <td align=right style="font-weight: bold; color: #f73131;">35,000원</td>
    <td  align=center>1인분 기준</td>
    <td>소금, 된장구비</td>
  </tr>
  <tr>
    <td>캠프파이어</td>
    <td align=right style="font-weight: bold; color: #f73131;" >55,000원</td>
    <td  align=center>1시간 기준</td>
