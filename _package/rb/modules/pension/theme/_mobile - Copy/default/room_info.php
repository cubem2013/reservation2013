...
<script src="<?php echo $g['dir_module_skin'] = $g['dir_module'].'theme/'.$dispType.'/'.$theme.'/'?>/query.flexslider.js"></script>
...
<div class="t_type1" >
  ...
  <tr>
    ...
    <td><font style="background:#FFd0d0; padding:1px 1px 1px 1px;">기준인원</font> 2명<br /></td>
