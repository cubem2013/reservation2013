...
<div class="title">주변전경</div>
	...
	<div class="fluid_container">
        <div class="camera_wrap camera_magenta_skin" id="camera_wrap_1">
            <div data-thumb="./modules/pension/theme/_pc/default/image/panorama1.jpg" data-src="./modules/pension/theme/_pc/default/image/panorama1.jpg">
                <div class="camera_caption fadeFromBottom">
                   터치데이 펜션 전경 <em>다른 펜션엔 없다. 오직 터치데이 펜션에만 있습니다</em>
                </div>
            </div>
            <div data-thumb="./modules/pension/theme/_pc/default/image/panorama2.jpg" data-src="./modules/pension/theme/_pc/default/image/panorama2.jpg">
                <div class="camera_caption fadeFromBottom">
                    터치데이 펜션 전경 <em>다른 펜션엔 없다. 오직 터치데이 펜션에만 있습니다</em>
                </div>
            </div>
            <div data-thumb="./modules/pension/theme/_pc/default/image/panorama3.jpg" data-src="./modules/pension/theme/_pc/default/image/panorama3.jpg">
                <div class="camera_caption fadeFromBottom">
                    터치데이 펜션 전경 <em>다른 펜션엔 없다. 오직 터치데이 펜션에만 있습니다</em>
                </div>
            </div>
            
            <div data-thumb="./modules/pension/theme/_pc/default/image/panorama4.jpg" data-src="./modules/pension/theme/_pc/default/image/panorama4.jpg">
                <div class="camera_caption fadeFromBottom">
                    터치데이 펜션 전경 <em>다른 펜션엔 없다. 오직 터치데이 펜션에만 있습니다</em>
                </div>
            </div>
